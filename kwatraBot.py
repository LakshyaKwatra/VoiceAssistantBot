...
responses = ["I'm fine master","I'm doing great master!","I am good master!","I'm exactly the way you want me to be master!","I'm awesome my master!","I'm good master! You take very good care of me"]
var1 = ['who made you', 'who created you']
var2 = ['I have been created by Lakshya Kwatra.','Mr. Lakshya Kwatra built me']
...
repfr9 = ["You're welcome master!", 'Glad i could help you',"Please don't mention it master!","It is my sole duty to serve you master! Please don't thank me."]
...
def mail(rec_add):
    try:
        ...
        reply=hear()
        if 'no' in reply:
            speak("Please Compose the body of the mail Master!")
            print("Body: ",end='')
            body=input()
        else:
        ...
        if ans=='yes':
            ...
            speak("Sorry for the inconvienience! Let's try again Master!")
            mail(rec_add)               
...
def greet():
    ...
    if hour>=0 and hour<12:
        printSpeak("Good Morning Master!")

    elif hour>=12 and hour<17:
        printSpeak("Good Afternoon Master!")   

    else:
        printSpeak("Good Evening Master!")  
    printSpeak("KwatraBot at your service.")

def hear():
    r = sr.Recognizer()
    with sr.Microphone() as source:
        print("Say something Master:")
        audio = r.listen(source)
    try:
        print("Comprehending...")
        rec_google=r.recognize_google(audio,language='en-in')
        int_text=rec_google.lower()
        print("Master says: " + rec_google)
    except sr.UnknownValueError as e:
        print(e)
        print("Could not understand audio")
        printSpeak('Could you please say that again master?')
        return hear()
    return int_text    
...
while True:
    ...
    if int_text in greetings:
        ...
        printSpeak('Bye Master! Take care!')
        exit()
        ...
        printSpeak("Kindly don't use such language Master!")
